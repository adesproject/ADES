...
//      }
  ...
  public class TableColumn : DbDataItem
  {
    ...
    public TableColumn (string nm, FbDbType dt, int sz, int pr, int sc, bool nu) : base (nm, dt, sz, pr, sc)
    {
      isNullable = nu;
    }
  ...
  public class ProcParam : DbDataItem
  {
    ...
    public ProcParam (string nm, FbDbType dt, int sz, int pr, int sc, ParameterDirection pd) : base (nm, dt, sz, pr, sc)
    {
      direction = pd;
    }
