...
namespace Prolog
{
  public enum BI
  {
    ...
    persistent_info, persistent_uncache, pp_defines, predicatePN, predicateX,
    prob, probtimedecay, probdebuglevel,
    put, query_timeout, quit, read, retract, retract_where, retractall, see, seek, seen,
...
%         (A == B ; A \= B), !. % SWI-Prolog
       ...
       prob( P)                    :== prob.
       probtimedecay( B)           :== probtimedecay.
       probdebuglevel (B)               :== probdebuglevel.
