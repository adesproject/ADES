...
namespace Prolog
{
  ...
  public class PrologEngine
  {
    ...
    private int probDebugLevel = 1;
    public double resProb = 1;
    private bool timeDecayEnabled = true;
    private double decayFunction(long timeDiff) { return 1d-1d/(1d+Math.Pow(2.72,0.5*(30-timeDiff/10000000d)));}  //Sigmoid
...
PrologIO.Verbose)
    ...
    public void SetCurrentOutput(StringWriter sw)
    {
        Globals.SetCurrentOutput(sw);
    }
